...
const EV_GAME_DRAW_PHASE_TICK := "game.draw_phase_tick"
const EV_GAME_DRAW_PHASE_WARNING := "game.draw_phase_warning"
...
# ── EV_NET_* — Multiplayer layer (Prompt 17: lobby, host migration, ──────────
# reconnect, match session). Sub-namespace of network.* for the new
# networking stack; legacy EV_NETWORK_* events below stay for existing
# systems (e.g. MatchStateMachine listens to network.disconnected).
const EV_NET_ACTION_REJECTED := "net.action_rejected"
const EV_NET_BANDWIDTH_WARNING := "net.bandwidth_warning"
const EV_NET_HOST_ELECTED := "net.host.elected"
const EV_NET_HOST_LOST := "net.host.lost"
const EV_NET_HOST_TRANSFERRED := "net.host.transferred"
const EV_NET_LOBBY_CLOSED := "net.lobby.closed"
const EV_NET_LOBBY_CREATED := "net.lobby.created"
const EV_NET_LOBBY_JOINED := "net.lobby.joined"
const EV_NET_LOBBY_LEFT := "net.lobby.left"
const EV_NET_LOBBY_PLAYER_JOINED := "net.lobby.player_joined"
const EV_NET_LOBBY_PLAYER_LEFT := "net.lobby.player_left"
const EV_NET_LOBBY_PLAYER_READY := "net.lobby.player_ready"
const EV_NET_MATCH_EVENT := "net.match.event"
const EV_NET_MATCH_STATE_SYNC := "net.match.state_sync"
const EV_NET_OFFLINE := "net.offline"
const EV_NET_RECONNECTED := "net.reconnected"
const EV_NET_RECONNECT_FAILED := "net.reconnect_failed"
const EV_NET_RECONNECTING := "net.reconnecting"
